    ...
    children: [
      ...
      ScrollReveal(
        ...
        child: Padding(
          ...
          child: AutoSizeText(
            "I'm Utsav Kumar, a software developer. I engineer seamless systems where logic meets innovation — crafting backend architectures and full-stack flows that are as robust as they are scalable. With code as my canvas, I transform ideas into functional, future-ready solutions that don't just work — they perform.",
            style: Theme.of(
              context,
      ...
      Row(
        ...
        children: [
          ScrollReveal(
            ...
            child: _buildStatItem(context, '3', 'Months\nExperience'),
          ),
          ScrollReveal(
