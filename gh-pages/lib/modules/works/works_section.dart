        ...
        children: [
          ...
          if (isMobile) ...[
            ...
            _buildProject(
              context,
              'Whispr',
              'An NGL-inspired app for anonymous Q&A through a shareable link.',
              'assets/images/works/project2-11.png',
              ProjectType.desktop,
            ),
            _buildProject(
              context,
              'CNDOC',
              'Learn core Computer Networks concepts visually and interactively with CNDOC.',
              'assets/images/works/project3-22.png',
              ProjectType.desktop,
            ),
          ] else ...[
            _buildProject(
            ...
            _buildProject(
              context,
              'Whispr',
              'An NGL-inspired social app that lets you collect anonymous questions and candid feedback from your audience via a shareable link.',
              'assets/images/works/project2-11.png',
              ProjectType.desktop,
            ),
            _buildProject(
              context,
              'CNDOC',
              "CNDOC is an interactive platform designed to simplify core Computer Networks concepts through visual explanations and guided learning. It helps learners grasp protocols, architectures, and topologies with ease.",
              'assets/images/works/project3-11.png',
              ProjectType.desktop,
            ),
          ],
        ],
