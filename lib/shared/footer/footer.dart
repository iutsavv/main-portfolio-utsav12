...
class _FooterState extends State<Footer> {
  ...
  void _updateTime() {
    ...
    setState(() {
      _indianTime = formatter.format(istTime);
    });
  }
  ...
  Widget _buildDesktopLayout(BuildContext context) => Row(
        ...
        children: [
          ...
          const Row(
            children: [
              _SocialIcon(icon: Icons.code, tooltip: 'GitHub', url: 'https://github.com/iutsav12'),
              SizedBox(width: 16),
              _SocialIcon(icon: Icons.work, tooltip: 'LinkedIn', url: 'www.linkedin.com/in/utsav69'),
              SizedBox(width: 16),
              _SocialIcon(
            ...
            children: [
              Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .bodySmall
                    ?.copyWith(color: AppColors.textPrimary.withValues(alpha: .7), fontSize: 12),
              ),
              Text(
                'India $_indianTime',
                style: Theme.of(context)
            ...
            children: [
              ...
              const Row(
                children: [
                  _SocialIcon(icon: Icons.code, tooltip: 'GitHub', url: 'https://github.com/iutsav12'),
                  SizedBox(width: 12),
                  _SocialIcon(icon: Icons.work, tooltip: 'LinkedIn', url: 'https://www.linkedin.com/in/utsav69'),
                  SizedBox(width: 12),
                  _SocialIcon(
                    icon: LucideIcons.instagram,
                    tooltip: 'Instagram',
