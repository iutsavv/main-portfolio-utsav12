...
class _ContactSectionState extends State<ContactSection> {
  ...
  Future<void> _openEmailClient() async {
    try {
      ...
      final mailtoUrl = 'mailto:iutsavkumar12@gmail.com?subject=$subject&body=$body';
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text('Error: Please email me directly at iutsavkumar12@gmail.com')),
              ],
            ),
  ...
  Widget _buildContent(ThemeData theme) => Column(
    ...
    children: [
      ...
      Text(
        'Have a project in mind? Send me a message below or email me directly at iutsavkumar12@gmail.com',
